def startContainer(container_name):
    ...
    _, (status, id) = checkContainerStat(container_name)
    if status == 'created' or status == 'exited':
        ...
        print('the container {container} is paused, unpause it instead.'.format(container = container_name))
...
def stopContainer(container_name):
    ...
    if status == 'running' or status == 'paused':
        ...
        print('the container {container} is exited.'.format(container = container_name))
...
def pauseContainer(container_name):
    ...
    if status == 'running':
        ...
        print('the container {container} is paused.'.format(container = container_name))
    elif status == 'exited':
...
def removeContainer(container_name, force):
    ...
    import docker
    from radiolabdocker.CheckStat import checkContainerStat
    _, (_, id) = checkContainerStat(container_name)
