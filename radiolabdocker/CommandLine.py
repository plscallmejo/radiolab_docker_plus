...
def cli():
    ...
    cmd_run.add_argument('--home_dir', action='store', nargs='?', default='~/.radiolabdocker', help='???')
    cmd_run.add_argument('--mount', '-m', action='store', nargs='?', default='~/.radiolabdocker', help='???')
